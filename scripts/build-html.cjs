...
const js = jsFiles.reduce((biggest, f) => { const sizeA = fs.statSync("dist/client/assets/" + biggest).size; const sizeB = fs.statSync("dist/client/assets/" + f).size; return sizeB > sizeA ? f : biggest; });
